...
![Various baseline model predictions on an example training window.](figs/extrapolation_baselines.svg){#fig-baselines width=100%}
...
Gradient boosted tree based methods are typically recommended for learning from tabular time series data. The motivation behind using boosted trees are that they can find



: ... (Scale inv, nan handling, large tabular rows, interactions via splits) (fill in section)
