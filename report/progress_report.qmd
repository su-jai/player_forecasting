...
## Baselines
Before evaluating various models, we should set a benchmark or baseline performance measure against which to judge. We take the performance metric to be the root mean squared error of the log transformed target and choose two crude baseline models: 
...
The resulting performances are in the below table.
...
<!-- TODO: HistGradientBoostingRegressor, default hyperparameters,
56 window values + time index + log causal peak -> CV RMSE 0.4471.
One paragraph on why boosted trees suit this data: scale-invariance,
native NaN handling, interactions via splits, strong at ~10^5 tabular rows. -->
